    ...
    <div class="panel custom__panel">
        ...
        <div class="panel-body">
            <div class="block block__with-table">
                ...
                <div class="action-btn pull-right">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="name-value-wrap" target="_blank" href="{{$contract->file_url}}">@lang('global.pdf')</a></li>
                            @if($contract->word_file !='')
                                <li><a class="name-value-wrap" href="{{route('contract.download', $contract->id)}}">@lang('global.word')</a></li>
                            @endif
                        </ul>
                    </div>
                    @endif
                ...
                <div class="pull-left">
                    <div class="clearfix">
                        <a href="{{route('contract.edit', $contract->id)}}" class="btn btn-default pull-left edit-btn">@lang('contract.edit_metadata')</a>
                    @if($status == $contract_processing_completed)
                            <div class="pull-left">
                                <a href="{{route('contract.review', ['id'=>$contract->id])}}" class="btn btn-default">
                                    @lang('contract.view_pages')
                                </a>
                                <a href="{{route('contract.annotate', ['id'=>$contract->id])}}"class="btn btn-default">
                        ...
                        @elseif($status== $contract_processing_running)
                            <div class="status"><strong>@lang('contract.status')</strong>: @lang('contract.processing')</div>
                        @elseif($status == $contract_processing_pipline)
                            <div class="status"><strong>@lang('contract.status')</strong>: @lang('contract.pipeline')</div>
                        @endif
                    </div>
                </div>
                ...
                <ul>
                    ...
                    <li class="name-value-wrap">
                        ...
                        @if(isset($contract->created_user->name))
                            <span class="value"> {{$contract->created_user->name}}  @lang('global.on') {{$contract->created_datetime->format('D M d, Y h:i A')}} (GMT)
                            </span>
                        @endif
                    </li>
                            ...
                            <h3>@lang('contract.company') </h3>
                                ...
                                @foreach($companies as $k => $v)
                                        ...
                                        @if(isset($v->participation_share))
                                            <li class="name-value-wrap">
                                                <span class="name"> <strong>@lang('contract.participation_share'):</strong></span>
                                                 <span class="value">
                                        ...
                                        <li class="name-value-wrap">
                                            <span class="name"> <strong>@lang('contract.corporate_grouping'):</strong></span>
                                             <span class="value">
            ...
            <div class="block">
                ...
                <div class="project-wrapper">
                    <ul>
                        ...
                        <li class="name-value-wrap">
                            <span class="name"> <strong>@lang('contract.project_identifier'):</strong></span>
                            <span class="value">
                    ...
                    <div class="license-wrap">
                        @foreach($contract->metadata->concession as $key => $concession)
                            ...
                            @if(isset($concession->license_name))
                                <li class="name-value-wrap">
                                    <span class="name"> <strong>@lang('contract.license_name_only'):</strong></span>
                                     <span class="value">
                            ...
                            @if(isset($concession->license_identifier))
                                <li class="name-value-wrap">
                                    <span class="name">  <strong>@lang('contract.license_identifier_only'):</strong></span>
            ...
            <div class="associated-wrapper block">
                ...
                @if(!empty($associatedContracts))
                    ...
                    @endforeach
                @else
                   <ul><li> @lang('contract.no_documents')</li></ul>
                @endif
            </div>
